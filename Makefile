...
# 编译器设定和编译选项
CC = gcc -DCMM_DEBUG_LAB3TRACE -O0 -DDEBUG -ggdb -fsanitize=address -fsanitize=undefined -fno-omit-frame-pointer -lrt -fno-sanitize-recover -fstack-protector -D_GLIBCXX_DEBUG -D_GLIBCXX_DEBUG_PEDANTIC -fno-sanitize=leak
CC := gcc
